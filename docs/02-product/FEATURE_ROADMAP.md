...
| Lanjutan | Platform | Mobile app (Flutter), multi-tenant SaaS untuk perusahaan outsourcing lain, integrasi API (e-signature, BPJS) | 🔄 Berjalan — TTE kontrak selesai (adapter sandbox/PrivyID via `ESIGN_PROVIDER`); BPJS & mobile menyusul |
