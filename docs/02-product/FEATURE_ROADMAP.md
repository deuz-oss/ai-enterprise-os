...
| Lanjutan | Platform | Mobile app (Flutter), multi-tenant SaaS untuk perusahaan outsourcing lain, integrasi API (e-signature, BPJS) | 🔄 Berjalan — TTE kontrak ✅ & rekap iuran BPJS + ekspor CSV portal ✅; koneksi API resmi BPJS/multi-tenant/mobile menyusul |
