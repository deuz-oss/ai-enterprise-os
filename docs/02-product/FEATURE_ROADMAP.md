...
|------|-----------|-----------|--------|
| 1 | **MVP: Pre-sales s/d Rekrutmen** | Pipeline lead, aktivitas, konversi ke klien, upload dokumen legalitas (PKS/addendum), job order, database kandidat, seleksi & placement | 🚧 Dikembangkan |
| 2 | HRD | Database karyawan, kontrak kerja, tracking tanda tangan, dokumen HR (KTP/NPWP/BPJS), reminder akhir kontrak | ⏳ Direncanakan |
