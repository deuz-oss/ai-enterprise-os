...
def health_live() -> StatusResponse:
    return StatusResponse(status="ok", service="organization-service")
...
def version() -> dict[str, str]:
    return {"service": "organization-service", "version": "0.1.0"}


@app.get("/metrics")
def metrics() -> dict[str, object]:
    return {"service": "organization-service", "requests_total": 0, "errors_total": 0}
