...
def health_live() -> StatusResponse:
    return StatusResponse(status="ok", service="identity-service")
...
def version() -> dict[str, str]:
    return {"service": "identity-service", "version": "0.1.0"}


@app.get("/metrics")
def metrics() -> dict[str, object]:
    return {"service": "identity-service", "requests_total": 0, "errors_total": 0}
