...
def health_live() -> StatusResponse:
    return StatusResponse(status="ok", service="search-service")
...
def version() -> dict[str, str]:
    return {"service": "search-service", "version": "0.1.0"}


@app.get("/metrics")
def metrics() -> dict[str, object]:
    return {"service": "search-service", "requests_total": 0, "errors_total": 0}
